  ...
  return (
    <Tag
      ...
      style={{
        ...
        boxShadow: `inset 0 1px 0 rgba(196,196,204,0.04), 0 0 32px ${tokens.muted}`,
      }}
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <h3 className={cn("font-display text-silver-bright/90", compact ? "text-lg mt-3" : "text-2xl mt-4")}>
          {sign}
        </h3>
        <p className="text-[10px] text-silver-muted/85 tracking-[0.2em] uppercase mt-1">
          {traits.archetype} · {traits.element}
        </p>
        {!compact && (
          <p className="text-sm text-silver-muted leading-relaxed mt-4">{traits.emotional}</p>
        )}
      </div>
    </Tag>
  );
