...
```ts
import { useInsertUser, useCreateChatSession, useCreateMessage, useGetUserInsights } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetUserInsights();
...
```js
import { insertUser, createChatSession, createMessage, getUserInsights } from '@dataconnect/generated';
